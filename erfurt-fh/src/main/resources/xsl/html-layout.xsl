            ...
            <xsl:variable name="href">
              <xsl:choose>
                <xsl:when test="$CurrentLang = 'de'">
                  <xsl:value-of select="'https://www.fh-erfurt.de/de/'"/>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="'https://www.fh-erfurt.de/en/'"/>
                </xsl:otherwise>
              </xsl:choose>
            </xsl:variable>
            <a href="{$href}">
              <div id="wordmark" class="mb-2"/>
            </a>
          </div>
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  ...
                  <a href="https://www.fh-erfurt.de/zentrale-einrichtungen/hochschulbibliothek">
